...
if(isset($_POST['signup'])){
  ...
  $result=mysqli_query($conn,"insert into product_admin values('$uName','$email','$password',$mobile,'$filePath')") or die("Error in insertion of record or Your account is previosly created");
