...
<body>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post' enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <textarea name="highlight" class='form-control' cols="70" rows="4" ></textarea>
                    </div>
                    <label for="for-textarea2" class="form-label">Service</label>
                    <div class="form-group">
                        <textarea name="service" class='form-control'  cols="70" rows="4" ></textarea>
                    </div>
                    <label for="for-textarea3" class="form-label">Product Specification</label>
                    <div class="form-group">
                        <textarea name="speci" class='form-control'  cols="70" rows="4" ></textarea>
                    </div>
                    <label for="pName" class="form-label">Product Detail</label>
                    <div class="form-group">
                        <textarea name="pDetail" class='form-control'  cols="70" rows="4" ></textarea>
                    </div>
  ...
  if(isset($_POST['add-product'])){
    ...
    if($pIdError=='' && $pNameError=="" && $pPriceError=="" && $pColorError=="" && $pDimensionError==""){
      ...
      // insert record
      $sql2= "insert into `$catName2` (productName,Price,dimension,color,highlight,service,specification,productDetail,imagePath) values('$pName',$pPrice,'$pDimension','$pColor','$highlight','$service','$speci','$pDetail','$filePath')";
      echo "$sql2";
      ...
      if($result2){
          ...
          echo ("Error in insertion of product, please check");
