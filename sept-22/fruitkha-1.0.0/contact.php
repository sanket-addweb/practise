				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
						<form type="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );" method="post">
							...
							<p><input type="submit" value="Submit" name='submit-contact'></p>
						</form>
					</div>
				</div>
				<div class="col-lg-4">
...
if(isset($_POST['submit-contact'])){
	...
	$sql1="insert into `contact_us` values(:userId,':name',':email',:phone,':subject',':msg')";

	$query1= $pdo -> prepare($sql1);
	$query1 -> bindParam(':userId',$userId2,PDO::PARAM_INT);
	$query1 -> bindParam(':name',$firstName,PDO::PARAM_STR);
	$query1 -> bindParam(':email',$email,PDO::PARAM_STR);
	$query1 -> bindParam(':phone',$phone,PDO::PARAM_INT);
	$query1 -> bindParam(':subject',$subject,PDO::PARAM_STR);
	$query1 -> bindParam(':msg',$msg,PDO::PARAM_STR);
